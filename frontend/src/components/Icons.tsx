...
export function ChatBubbleIcon({ className, filled }: { className?: string; filled?: boolean }) {
  return (
...
export function HelpCircleIcon({ className, filled }: { className?: string; filled?: boolean }) {
  if (filled) {
    return (
      <svg className={className} width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm.75 15.5h-1.5V16h1.5v1.5zm1.34-5.49c-.58.43-.84.77-.84 1.49v.5h-1.5v-.5c0-1.12.47-1.85 1.34-2.48.76-.55 1.16-.95 1.16-1.77 0-.9-.7-1.5-1.75-1.5-.93 0-1.64.47-1.82 1.4l-1.43-.3C9.5 6.98 10.55 6 12.5 6c2 0 3.25 1.06 3.25 2.75 0 1.3-.7 1.9-1.66 2.26z" />
      </svg>
    )
  }
  return (
...
export function CheckCircleIcon({ className }: { className?: string }) {
  return (
    <svg className={className} width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm-1.1 14.5L6.4 12l1.4-1.4 3.1 3.1 5.3-5.3 1.4 1.4-6.7 6.7z" />
    </svg>
  )
}
