  ...
  return (
    <>
      <header className="relative z-40">
        ...
        >
          <div className="bg-[#f5f5f5] flex items-center justify-between px-6 h-10">
            <JordanLogo className="w-6 h-6 text-black" />
        ...
        <div
          ...
          style={{ position: scrolled ? 'fixed' : 'relative', top: 0, left: 0, right: 0, zIndex: 40, boxShadow: scrolled ? '0 1px 4px rgba(0,0,0,0.08)' : 'none' }}
        >
          <div className="relative flex items-center px-6 h-[60px]">
            {/* Nike logo — left */}
            <div className="flex-1 flex items-center">
              <Link to="/" className="flex-shrink-0">
                <svg width="60" height="22" viewBox="0 0 60 22" fill="black" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <button
                    className={`text-sm font-medium pb-1 border-b-2 transition-colors duration-150 ${
                      hoveredItem === item
                        ...
                        : 'border-transparent text-[#111] hover:text-black'
                    }`}
                  >
                    {item}
                  </button>
            ...
            <div className="flex-1 flex items-center justify-end gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 bg-[#e8e8e8] rounded-full pl-3 pr-5 py-2 text-sm font-medium text-[#111] hover:bg-[#d8d8d8] transition-colors"
              >
                <SearchIcon className="text-[#111] w-4 h-4" />
                <span>Search</span>
              </button>
              {/* Heart */}
              <button
                onClick={() => handleProtectedNav('/favorites')}
                className="p-1.5 rounded-full hover:bg-[#f5f5f5] transition-colors text-[#111]"
        ...
        >
          <div className="bg-[#f5f5f5] flex items-center justify-center h-9 text-xs text-[#111]">
            {currentPage}
          </div>
        </div>
      ...
      {searchOpen && (
        ...
        >
          ...
          <div
            ...
            style={{ animation: 'searchPanelIn 0.25s ease-out' }}
          >
